...
### 1.1 App Icon
- [x] App icon already created in asset, confirm it that is what you will use  it should aready be in path `assets/app_logo.png`
...
- [x] Full description (max 4000 chars) (do not use markdown systax, just plan text
- [x] Create `docs/release/play_store_listing.txt`
